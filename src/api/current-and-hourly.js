export default async function getForcast() {
    const forcast = await fetch(
        "http://api.weatherapi.com/v1/forecast.json?key=013d87f7b7f644169ee154512231207&q=peshawar&days=1&aqi=no&alerts=no"
    ).then((res) => res.json());
